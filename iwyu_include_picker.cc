...
const IncludeMapEntry libc_include_map[] = {
  ...
  // plainly defining rules for x86intrin.h
  { "<ia32intrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<mmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<xmmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<emmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<pmmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<tmmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<ammintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<smmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<wmmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<immintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<mm3dnow.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<fma4intrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<xopintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<lwpintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<bmiintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<bmi2intrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<tbmintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<lzcntintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<popcntintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<rdseedintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<prfchwintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<fxsrintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<xsaveintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<xsaveoptintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<adxintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<clwbintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<pcommitintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<clflushoptintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<xsavesintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<xsavecintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<mwaitxintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<clzerointrin.h>", kPrivate, "<x86intrin.h>", kPublic },
  { "<pkuintrin.h>", kPrivate, "<x86intrin.h>", kPublic },
};
