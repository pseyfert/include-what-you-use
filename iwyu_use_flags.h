...
static const UseFlags UF_None = 0;
static const UseFlags UF_InCxxMethodBody = 1; // use is inside a C++ method body
static const UseFlags UF_FunctionDfn = 2; // use is a function being defined
